...
"""
Este script roda um modelo baseado no DAN.
Em vez de usar como entrada um batch com as mesmas quantidades de exemplo do source e do target,
    treinamos estes modelo de forma estocátisca.
...
from model.StochasticDANModel import StochasticDANModel
...
def main(args):
    ...
    model = StochasticDANModel(inputModel, supervisedLabel, unsupervisedLabel,
